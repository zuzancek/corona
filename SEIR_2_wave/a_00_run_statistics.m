...
[pdf_d_y_s,cdf_d_y_s] = apply_censoring(tb.P_D_Y./alpha_d_y,25);
[pdf_d_o_s,cdf_d_o_s] = apply_censoring(tb.P_D_O./alpha_d_o,25);
...
[pdf_r_y_s,cdf_r_y_s] = apply_censoring(tb.P_R_Y./alpha_r_y,25);
[pdf_r_o_s,cdf_r_o_s] = apply_censoring(tb.P_R_O./alpha_r_o,25);
