...
% infectious period
s.T_inf.mean = 4.4;             s.T_inf.std = 0.62;
...
s.smoothing_method_params = @smooth_series;
    ...
    function[]=set_prob_data()
        ...
        s.T_death_y_mean = db_t.opt_fit_d_y.emean;
        s.T_death_o_mean = db_t.opt_fit_d_o.emean;
        ...
        s.T_death_y_mean_s = db_s.opt_fit_d_y.emean;
        s.T_death_o_mean_s = db_s.opt_fit_d_o.emean;
        ...
        s.T_ser_y_mean = db_s.opt_fit_h_y.emean;
        s.T_ser_o_mean = db_s.opt_fit_h_o.emean;
        ...
        s.T_hosp_y_mean = db_t.opt_fit_h_y.emean+1;
        s.T_hosp_o_mean = db_t.opt_fit_h_o.emean;
        ...
        s.T_rec_h_y_mean = db_t.opt_fit_r_y.emean;
        s.T_rec_h_o_mean = db_t.opt_fit_r_o.emean;
        ...
        s.T_rec_s_y_mean = db_s.opt_fit_r_y.emean;
        s.T_rec_s_o_mean = db_s.opt_fit_r_o.emean;
        ...
        s.T_rec_y_mean = db_t.opt_fit_r_y.emean;
        s.T_rec_o_mean = db_t.opt_fit_r_o.emean;
