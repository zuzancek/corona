...
pp1=bar(db.X_rep_raw,'FaceAlpha',0.85);hold on;
...
plot(db.X_rep_smooth,'b','linewidth',2);
...
if implied
    ...
    pp3=bar(db.H); hold on;
    pp5=bar(db.D,'FaceAlpha',0.5);hold on;
    pp7=bar(db.S,'FaceColor',0.25*[1 1 1]); hold on;
    pp1=plot(smooth_series(db.X),'linewidth',2,'Color',[0.75 0.75 0]);hold on; 
...
if reported
    ...
    pp3=bar(db_alt.H); hold on;
    pp5=bar(db_alt.D,'FaceAlpha',0.5);hold on;
    pp7=bar(db_alt.S,'FaceColor',0.25*[1 1 1]); hold on;
    pp1=plot(smooth_series(db_alt.X),'linewidth',2,'Color',[0.75 0.75 0]);hold on; 
    plot(out_rep.X,'Color',[0.5 0.5 0.5]);hold on;
    pp2=plot((resize(db_rep.H,dateFrom:dateTo)),'b','linewidth',2);hold on;
    pp6=plot((resize(db_rep.S,dateFrom:dateTo)),'k','linewidth',2);hold on;
    pp4=plot((resize(db_rep.D,dateFrom:dateTo)),'r','linewidth',2);hold on;
