...
T_symp = 5;
T_hosp0 = 4+T_symp; % s.T_hosp.mean;            % 4;
...
omega_icu = 4.92/100;       T_rec_icu = 12.8;   x_icu = smooth_series(h.ICU(dateFrom:dateTo),s.smooth_width,s.smooth_type,s.smooth_ends);
...
lambda = 0.125;%s.lambda;                  % 6.37/100
