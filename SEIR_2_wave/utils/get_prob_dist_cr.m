function [opt_fit,kernel_fit,pdf_grid,cdf_grid,rv_grid] = get_prob_dist_cr(N_rand,time_grid,pdf_base_grid,varargin)

% input: time-dependent probability calculated using cumulated incidence 
...
% key variable
pdf_grid = pdf_base_grid; pdf_grid = pdf_grid./sum(pdf_grid);
