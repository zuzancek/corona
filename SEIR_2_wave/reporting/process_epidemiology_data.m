...
test_data.tests_pcr_raw = x.Tests;             test_data.tests_pcr = mov_median_adj(x.Tests);           test_data.test_pcr_smooth = smooth_series(test_data.tests_pcr);
test_data.tests_ag_raw = y.AgTests;            test_data.tests_ag = mov_median_adj(y.AgTests);          test_data.test_ag_smooth = smooth_series(test_data.tests_ag);
