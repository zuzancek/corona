...
# R-code by Jakub Cervený (jakub.cerveny@health.gov.sk), IZA MZSR
...
output_folder="results/reported"
...
hospital_data<-read.csv((hosp_data), header = TRUE, sep=";")
...
covid_data<-read.csv((data), header = TRUE, sep=";")
